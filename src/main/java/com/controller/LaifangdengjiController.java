    ...
    */
    ...
    public R save(@RequestBody LaifangdengjiEntity laifangdengji, HttpServletRequest request){
        ...
        Wrapper<LaifangdengjiEntity> queryWrapper = new EntityWrapper<LaifangdengjiEntity>()
            ...
            .eq("laifangdengji_name", laifangdengji.getLaifangdengjiName())
            ;
...
//                            laifangdengjiEntity.setYonghuId(Integer.valueOf(data.get(0)));   //老人 要改的
//                            laifangdengjiEntity.setLaifangdengjiName(data.get(0));                    //来访人名称 要改的
//                            laifangdengjiEntity.setLaifangdengjiTime(sdf.parse(data.get(0)));          //来访时间 要改的
//                            laifangdengjiEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestBody LaifangdengjiEntity laifangdengji, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,laifangdengji:{}",this.getClass().getName(),laifangdengji.toString());
        Wrapper<LaifangdengjiEntity> queryWrapper = new EntityWrapper<LaifangdengjiEntity>()
            .eq("yonghu_id", laifangdengji.getYonghuId())
            .eq("laifangdengji_name", laifangdengji.getLaifangdengjiName())
            ;
