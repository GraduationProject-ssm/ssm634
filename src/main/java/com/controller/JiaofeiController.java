...
//                            jiaofeiEntity.setYonghuId(Integer.valueOf(data.get(0)));   //老人 要改的
//                            jiaofeiEntity.setJiaofeiName(data.get(0));                    //缴费原因 要改的
//                            jiaofeiEntity.setJiaofeiTime(sdf.parse(data.get(0)));          //缴费时间 要改的
