    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuEntity==null){
            ...
            return R.error(511,"账户或者联系方式或者老人身份证号已经被使用");
        }
    }
...
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //老人身份证号 要改的
//                            yonghuEntity.setYonghuKahao(data.get(0));                    //医保卡号 要改的
//                            yonghuEntity.setYonghuEmail(data.get(0));                    //邮箱 要改的
//                            yonghuEntity.setYonghuJiguan(data.get(0));                    //籍贯 要改的
//                            yonghuEntity.setYonghuTime(sdf.parse(data.get(0)));          //入院日期 要改的
...
//    	ValidatorUtils.validateEntity(user);
        ...
        YonghuEntity yonghuEntity = yonghuService.selectOne(queryWrapper);
        if(yonghuEntity != null)
            return R.error("账户或者联系方式或者老人身份证号已经被使用");
        yonghu.setYonghuDelete(1);
        yonghu.setCreateTime(new Date());
        yonghuService.insert(yonghu);
        return R.ok();
