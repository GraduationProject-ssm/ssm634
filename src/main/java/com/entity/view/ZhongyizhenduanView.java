...
public class ZhongyizhenduanView extends ZhongyizhenduanEntity implements Serializable {
	...
	public ZhongyizhenduanView() {

	}

	public ZhongyizhenduanView(ZhongyizhenduanEntity zhongyizhenduanEntity) {
		try {
			BeanUtils.copyProperties(this, zhongyizhenduanEntity);
